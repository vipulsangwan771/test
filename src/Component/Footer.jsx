                    ...
                    <div className='disflds w-100' >
                        <div className='aswsaaq '>
                            ...
                            <div style={{ display: 'flex', gap: '20px' }}>
                                <div>
                                    <a href='https://www.instagram.com/kendamiluk/' style={{cursor:'pointer'}}>
                                ...
                                <div>
                                    <a href='https://www.facebook.com/Kendamil' style={{cursor:'pointer'}}>
                                ...
                                <div>
                                    <a href='https://x.com/kendamiluk' style={{cursor:'pointer'}}>
                                ...
                                <div>
                                    <a href='https://www.youtube.com/c/Kendamil' style={{cursor:'pointer'}}>
                                        <img style={{ cursor: 'pointer' }} src={utube} width={30} height={30} alt="" />
                                    </a>
                                </div>
                            </div>
                            <div className='maras w-100'>
                               <a href="https://api.whatsapp.com/send/?phone=441539480002&text&type=phone_number&app_absent=0">
                        ...
                        <Accordion className='w-100 diblonon'>
                            ...
                            <Accordion.Item eventKey="2">
                                ...
                                <p className='acorpara'> <Link to="/about">About</Link>  </p>
                                <p className='acorpara'> <Link to="/shop">Shop</Link>  </p>
                                <p className='acorpara'>   <Link to="/blog">Blog</Link>  </p>
