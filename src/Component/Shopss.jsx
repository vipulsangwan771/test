...
import ss from './Assests/ss.webp';
import banmss from './Assests/shposs.webp';
import shopa8 from './Assests/shopall8.webp';
import ss1 from './Assests/ss1.svg';
import ss2 from './Assests/ss2.svg';
import ss3 from './Assests/ss3.svg';
import ss4 from './Assests/ss4.svg';
import ss5 from './Assests/ss5.svg';
...
const Shopss = () => {
    ...
    const products = [
        { id: 1, name: 'Pro-Comfort Baby Drops', price: 14.99, img: shopa8, date: new Date('2023-05-01'), ageGroup: '0-12 months' },
        { id: 2, name: 'Comfort Milk', price: 15.49, img: banmss, date: new Date('2023-06-15'), ageGroup: '0-3 months' },
    ];
            ...
            <section style={{ paddingTop: '90px', backgroundColor: '#FDFBF9' }}>
                ...
                <section style={{ backgroundColor: '#F7DADF' }}>
                    <div className='nmanshop'>
                        ...
                        <a href="#" className='undlinsho'>Specialty & Supplements</a>
                    ...
                    <div className='w-100 shopallmain'>
                        ...
                        <div className='w-100'>
                            ...
                            <div className='stshoplef'>
                                <h1>Specialty & Supplements</h1>
                                <p> Specialty Formula & Supplements</p>
                            </div>
                        </div>
                        <div className='w-100' style={{ overflow: 'hidden' }}>
                            <img src={ss} className='w-100 ' alt="" />
                        </div>
                    </div>
                </section>
                    ...
                    <div className='shoaii' >
                        <div style={{ marginBottom: '20px' }}>
                            ...
                            <select className='filselaccag' id='ageGroup' value={ageGroupFilter} onChange={(e) => setAgeGroupFilter(e.target.value)}>
                                ...
                                <option value='0-12 months'>0-12 months(1)</option>
                                <option value='0-3 months'>0-3 years(1)</option>
                            </select>
                        </div>
                        <div style={{ marginBottom: '20px' }}>
                    ...
                    <Slider {...sho1settings} style={{ paddingTop: '50px', paddingBottom: '3px', maxWidth: '1024px', margin: 'auto', textAlign: 'center', margin: 'auto' }}>
                        <div className=' fontt' style={{ width: '156.4px', marginRight: '63px', textAlign: 'center' }}>
                            <div className='imamarlefqwmkl'>
                                <img style={{ maxWidth: '70px' }} src={ss1} alt="" />
                            </div>

                            <p style={{ fontSize: '18px', fontWeight: '600', lineHeight: '23px', color: '#071F60', marginBottom: '15px', textTransform: 'capitalize' }}>British Made</p>
                            <p style={{ fontSize: '15px !Important', fontWeight: '600', lineHeight: '23px', color: '#071F60', }}>we're a proud British business, at home in the Lake District</p>
                        </div>

                        <div className=' fontt' style={{ width: '154.4px', marginRight: '63px', textAlign: 'center' }}>
                            <div className='imamarlefqwmkl'>
                                <img style={{ maxWidth: '70px' }} src={ss2} alt="" />
                            </div>

                            <p style={{ fontSize: '18px', fontWeight: '600', lineHeight: '23px', color: '#071F60', marginBottom: '15px', textTransform: 'capitalize' }}>Family Founded</p>
                            <p style={{ fontSize: '15px', fontWeight: '600', lineHeight: '23px', color: '#071F60', }}> we put your family first, because we are one</p>
                        </div>

                        <div className='fontt' style={{ width: '150.4px', textAlign: 'center' }}>
                            <div className='imamarlefqwmkl'>
                                <img style={{ maxWidth: '70px' }} src={ss3} alt="" />
                            </div>
                            ...
                            <p style={{ fontSize: '15px', fontWeight: '600', lineHeight: '23px', color: '#071F60', }}>we're proud to always be Palm Oil free at Kendamil</p>
                        </div>

                        <div className=' fontt' style={{ width: '154.4px', marginRight: '63px', textAlign: 'center' }}>
                            <div className='imamarlefqwmkl'>
                                <img style={{ maxWidth: '70px' }} src={ss4} alt="" />
                            </div>
                        ...
                        <div className='fontt' style={{ width: '150.4px', textAlign: 'center' }}>
                            <div className='imamarlefqwmkl'>
                                <img style={{ maxWidth: '70px' }} src={ss5} alt="" />
                            </div>
