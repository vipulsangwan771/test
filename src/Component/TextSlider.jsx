...
const TextSlider = () => {
    ...
    const items = [
        { img: textimg1, alt: "Organic Follow-On Milk", price: "£12.00" },
        { img: textimg2, alt: "Organic Follow-On Milk", price: "£12.00" },
        { img: textimg3, alt: "Organic Toddler Milk", price: "£12.00" },
        { img: textimg4, alt: "Classic Toddler Milk", price: "£12.00" },
        { img: textimg5, alt: "5-Pack Banana Baby Porridge", price: "£12.50" },
        { img: textimg6, alt: "5-Pack Creamy Baby Porridge", price: "£11.25" }, ,
        { img: textimg7, alt: "5-Pack Apple and Blackcurrant", price: "£12.50" }, ,
        { img: textimg8, alt: "5-Pack Organic Banana and", price: "£12.50" }, ,
        { img: textimg9, alt: "5-Pack Organic Multigrain Porridge", price: "£6.25" },
    ];
                        ...
                        {items.map((item, index) => (
                            <div key={index} className='visisho'>
                                <div style={{ textAlign: 'center', backgroundColor: '#fff' }}>
                                    ...
                                    <p style={{ marginBottom: '2px', color: '#071F60', fontSize: '15px' }}>{item.alt}</p>
                                    ...
                                    <div className='visihidd'>
                                        <form action="/cart/add" method='post'>
                                            <div style={{ display: 'flex', alignItems: 'center', padding: '0px 10px' , paddingTop: '20px' , paddingBottom: '5px' }}>
                                                ...
                                                <button type="submit" style={{ }} className='w-100 addtbton'>add to cart</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
